...
public class Amazon {
    ...
    public void scrapeProductsAmazon() throws IOException {
        final String url = "https://www.amazon.com.tr/s?k=laptop&__mk_tr_TR=%C3%85M%C3%85%C5%BD%C3%95%C3%91&crid=2Q6RONOO8E31K&sprefix=laptop%2Caps%2C140&ref=nb_sb_noss_1";

        final Document document = Jsoup.connect(url).userAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.38 Safari/537.36").get();
        ...
        for (Element a : body.select("div.a-section.a-spacing-base")) {
            ...
            Product product = new Product(name, price, "https://www.amazon.com.tr/" + link);
